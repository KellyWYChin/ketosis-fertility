...
cor(survival$AvgKeto20_100, survival$MaxKetoDFC60) # -0.169
...
# put MaxKetoDFC60 into the model
cox6 <- coxph(Surv(DaysToFirstHeat, FirstHeat)~ AvgKeto20_100 + MaxKetoDFC60 + ad_Lactation + AvgMY60 + CalvingSeason + cut(CowNo, c(0, 100, 180, 1000)), data=survival)
cox6

# remove AvgMY60
cox7 <- coxph(Surv(DaysToFirstHeat, FirstHeat)~ AvgKeto20_100 + MaxKetoDFC60 + ad_Lactation + CalvingSeason + cut(CowNo, c(0, 100, 180, 1000)), data=survival)
cox7

# add PeakMY
cox8 <- coxph(Surv(DaysToFirstHeat, FirstHeat)~ AvgKeto20_100 + MaxKetoDFC60 + ad_Lactation + PeakMY + CalvingSeason + cut(CowNo, c(0, 100, 180, 1000)), data=survival)
cox8
```
...
coxme0
coxme1 <- coxme(Surv(DaysToFirstHeat, FirstHeat)~AvgKeto20_100 + MaxKetoDFC60 + ad_Lactation + PeakDFC + AvgMY60 + CalvingSeason + cut(CowNo, c(0, 100, 180, 1000)) + (1|FarmNo), data=survival)
coxme1
anova(coxme0, coxme1)
coxme2 <- coxme(Surv(DaysToFirstHeat, FirstHeat)~AvgKeto20_100 + MaxKetoDFC60 + ad_Lactation + PeakDFC + CalvingSeason + cut(CowNo, c(0, 100, 180, 1000)) + (1|FarmNo), data=survival)
coxme2
anova(coxme1, coxme2)
...
coxme2.keto <- coxme(Surv(DaysToFirstHeat, FirstHeat)~ MaxKetoDFC60 + ad_Lactation + PeakDFC + CalvingSeason + cut(CowNo, c(0, 100, 180, 1000)) + (1|FarmNo), data=survival)
...
plot(survival$MaxKetoDFC60, res.coxme2.ketodfc60, main = "Residual of AvgKeto20_100")
lines(lowess(survival$MaxKetoDFC60, res.coxme2.ketodfc60), col = "red")

# check PeakDFC in coxme2
coxme2.peakdfc <- coxme(Surv(DaysToFirstHeat, FirstHeat)~AvgKeto20_100 + MaxKetoDFC60 + ad_Lactation + CalvingSeason + cut(CowNo, c(0, 100, 180, 1000)) + (1|FarmNo), data=survival)
