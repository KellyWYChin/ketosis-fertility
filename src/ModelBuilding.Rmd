...
```{r}
# DFCFirstHeat
ggplot(data=survival, aes(x=DFCFirstHeat))+
  ...
  ylab("#cows")+
  theme_classic()
summary(survival$DFCFirstHeat)
var(survival$DFCFirstHeat)
sd(survival$DFCFirstHeat)

# BOXPLOT- DFCFirstHeat vs. FarmNo
plot(survival$DFCFirstHeat ~ survival$AvgKeto20_100)
boxplot(survival$DFCFirstHeat ~ survival$FarmNo, xlab = "Farm ID", ylab = "Days from calving to first heat")
ggplot(data = survival, aes(x = FarmNo, y = DFCFirstHeat)) +
  geom_boxplot(outlier.color = "red") + 
  theme_classic() +
  labs(x = "Farm ID", y = "Day from calving to first heat (days)") +
...
boxplot(survival$DFCFirstHeat ~ survival$ad_Lactation)
ggplot(data = survival, aes(x = ad_Lactation, y = DFCFirstHeat)) +
  geom_boxplot(outlier.color = "red") + 
  theme_classic() +
  labs(x = "Parity", y = "Day from calving to first heat (days)")
```

# Survival curves (DFCFirstHeat)
```{r}
surv.heat <- survfit(Surv(DFCFirstHeat, FirstHeat) ~ 1, data = survival)
...
surv1.heat <- survfit(Surv(DFCFirstHeat, FirstHeat) ~ ad_Lactation, data=survival)
print(surv1.heat)
...
surv2.heat <- survfit(Surv(DFCFirstHeat, FirstHeat) ~ KetoStatus20, data=survival)
summary(surv2.heat)
...
surv3.heat <- survfit(Surv(DFCFirstHeat, FirstHeat) ~ KetoQua, data=survival)
print(surv3.heat)
...
surv4.heat <- survfit(Surv(DFCFirstHeat, FirstHeat) ~ KetoMaxDay, data=survival)
print(surv4.heat)
...
surv5.heat <- survfit(Surv(DFCFirstHeat, FirstHeat) ~ KetoMaxDay2, data=survival)
print(surv5.heat)
...
surv6.heat <- survfit(Surv(DFCFirstHeat, FirstHeat) ~ CalvingYear, data = survival)
print(surv6.heat)
...
surv7.heat <- survfit(Surv(DFCFirstHeat, FirstHeat) ~ CalvingSeason, data = survival)
print(surv7.heat)
...
cox.ketostatus <- coxph(Surv(DFCFirstHeat, FirstHeat)~ KetoStatus20, data = survival)
cox.ketostatus
plot(survfit(cox.avgketo, conf.int = TRUE, data = survival))

cox.avgketo <- coxph(Surv(DFCFirstHeat, FirstHeat)~ AvgKeto20_100, data = survival)
cox.avgketo

cox.maxketo20 <- coxph(Surv(DFCFirstHeat, FirstHeat)~ MaxKeto20, data = survival)
cox.maxketo20

cox.MaxKetoDFC20 <- coxph(Surv(DFCFirstHeat, FirstHeat)~ MaxKetoDFC20, data = survival)
cox.MaxKetoDFC20

cox.nhighketo20 <- coxph(Surv(DFCFirstHeat, FirstHeat)~ nHighKeto20, data = survival)
cox.nhighketo20

cox.ketodur20 <- coxph(Surv(DFCFirstHeat, FirstHeat)~ KetoDur20, data = survival)
cox.ketodur20
```
...
```{r}
# Univariate Cox regression
cox.lactation <- coxph(Surv(DFCFirstHeat, FirstHeat)~ ad_Lactation, data = survival)
cox.lactation

cox.lactation1 <- coxph(Surv(DFCFirstHeat, FirstHeat)~ Lactation, data = survival)
cox.lactation1

cox.farmno <- coxph(Surv(DFCFirstHeat, FirstHeat)~ FarmNo, data = survival)
cox.farmno

cox.calvingseason <- coxph(Surv(DFCFirstHeat, FirstHeat)~ CalvingSeason, data = survival)
cox.calvingseason

cox.peakdfc <- coxph(Surv(DFCFirstHeat, FirstHeat)~ PeakDFC, data = survival)
cox.peakdfc

cox.peakmy <- coxph(Surv(DFCFirstHeat, FirstHeat)~ PeakMY, data = survival)
cox.peakmy

cox.avgmy20 <- coxph(Surv(DFCFirstHeat, FirstHeat)~ AvgMY20, data = survival)
cox.avgmy20

cox.summy20 <- coxph(Surv(DFCFirstHeat, FirstHeat)~ SumMY20, data = survival)
cox.summy20
```
...
```{r}
cox0 <- coxph(Surv(DFCFirstHeat, FirstHeat)~1, data=survival)
cox10 <- coxph(Surv(DFCFirstHeat, FirstHeat)~AvgKeto20_100, data = survival)

cox1 <- coxph(Surv(DFCFirstHeat, FirstHeat)~ AvgKeto20_100 + ad_Lactation + PeakDFC + AvgMY60 + CalvingSeason + cut(CowNo, c(0, 100, 180, 1000)), data=survival)
cox1

cox2 <- coxph(Surv(DFCFirstHeat, FirstHeat)~ AvgKeto20_100 + ad_Lactation + PeakMY + AvgMY60 + CalvingSeason + cut(CowNo, c(0, 100, 180, 1000)), data=survival)
cox2
anova(cox1, cox2)
...
cox3 <- coxph(Surv(DFCFirstHeat, FirstHeat)~ AvgKeto20_100 + ad_Lactation + PeakMY + PeakDFC + CalvingSeason + cut(CowNo, c(0, 100, 180, 1000)), data=survival)
cox3
...
cox4 <- coxph(Surv(DFCFirstHeat, FirstHeat)~ AvgKeto20_100 + ad_Lactation + PeakMY + CalvingSeason + cut(CowNo, c(0, 100, 180, 1000)), data=survival)
cox4
...
# only use AvgMY60
cox5 <- coxph(Surv(DFCFirstHeat, FirstHeat)~ AvgKeto20_100 + ad_Lactation + AvgMY60 + CalvingSeason + cut(CowNo, c(0, 100, 180, 1000)), data=survival)
cox5 # AvgMY60 is not significant in the model, can be removed
```

# Coxme model with random effect
```{r}
coxme1 <- coxme(Surv(DFCFirstHeat, FirstHeat)~AvgKeto20_100 + ad_Lactation + PeakDFC + AvgMY60 + CalvingSeason + cut(CowNo, c(0, 100, 180, 1000)) + (1|FarmNo), data=survival)
coxme1
anova(cox1, coxme1)
coxme2 <- coxme(Surv(DFCFirstHeat, FirstHeat)~AvgKeto20_100 + ad_Lactation + PeakDFC + CalvingSeason + cut(CowNo, c(0, 100, 180, 1000)) + (1|FarmNo), data=survival)
coxme2
...
##  Check Interaction  ##
#########################
coxme3 <- coxme(Surv(DFCFirstHeat, FirstHeat)~AvgKeto20_100 + ad_Lactation + AvgKeto20_100:ad_Lactation + PeakDFC + CalvingSeason + cut(CowNo, c(0, 100, 180, 1000)) + (1|FarmNo), data=survival)
coxme3
anova(coxme2, coxme3)
# don't need to consider interaction between ketosis and parity

coxme4 <- coxme(Surv(DFCFirstHeat, FirstHeat)~AvgKeto20_100 + ad_Lactation + AvgKeto20_100:PeakDFC + PeakDFC + CalvingSeason + cut(CowNo, c(0, 100, 180, 1000)) + (1|FarmNo), data=survival)
coxme4
anova(coxme2, coxme4)
...
```{r}
coxme1.keto <- coxme(Surv(DFCFirstHeat, FirstHeat)~KetoStatus20 + ad_Lactation + PeakDFC + AvgMY60 + CalvingSeason + cut(CowNo, c(0, 100, 180, 1000)) + (1|FarmNo), data=survival)
coxme1.keto
...
coxme1.keto <- coxme(Surv(DFCFirstHeat, FirstHeat)~ ad_Lactation + PeakDFC + AvgMY60 + CalvingSeason + cut(CowNo, c(0, 100, 180, 1000)) + (1|FarmNo), data=survival)
...
coxme1.peakdfc <- coxme(Surv(DFCFirstHeat, FirstHeat)~AvgKeto20_100 + ad_Lactation + AvgMY60 + CalvingSeason + cut(CowNo, c(0, 100, 180, 1000)) + (1|FarmNo), data=survival)
...
coxme2.keto <- coxme(Surv(DFCFirstHeat, FirstHeat)~ ad_Lactation + PeakDFC + CalvingSeason + cut(CowNo, c(0, 100, 180, 1000)) + (1|FarmNo), data=survival)
...
coxme2.peakdfc <- coxme(Surv(DFCFirstHeat, FirstHeat)~AvgKeto20_100 + ad_Lactation + CalvingSeason + cut(CowNo, c(0, 100, 180, 1000)) + (1|FarmNo), data=survival)
...
```{r}
coxme2.lact <- coxme(Surv(DFCFirstHeat, FirstHeat)~ AvgKeto20_100 + PeakDFC + CalvingSeason + cut(CowNo, c(0, 100, 180, 1000)) + (1|FarmNo), data=survival)
...
```{r}
## First Heat
df.cox1.heat <- coxph(Surv(DFCFirstHeat, FirstHeat) ~ ad_Lactation + AvgKeto20_atleast10 + MaxKetoDFC20 + PeakDFC + AvgMY20 + CalvingSeason  + factor(FarmNo), data = survival)
