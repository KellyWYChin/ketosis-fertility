...
summary(Three$MaxKetoDFC20)
summary(Three$KetoDur20)
plot(Three$MaxKetoDFC20)
...
summary(Three$MaxKetoDFC20)
ggplot(data=Three, aes(x=MaxKetoDFC20)) +
...
summary(Three$MaxKetoDFC60)
ggplot(data=Three, aes(x=MaxKetoDFC60)) +
...
summary(Three$MaxKetoDFC60)
Three$MaxKetoD <- ifelse(Three$MaxKetoDFC60 <= 20, 1, 0)
