...
table(repro$Last_AI) #How many times does a cow be inseminated?

# Number of cows vs number of AI
repro$Last_AI <- as.factor(repro$Last_AI)
ggplot(data=repro, aes(x=factor(Last_AI))) +
