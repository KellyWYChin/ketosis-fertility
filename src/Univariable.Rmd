...
table(reproduction$Last_AI) #How many times does a cow be inseminated?

# Number of cows vs number of AI
reproduction$Last_AI <- as.factor(reproduction$Last_AI)
ggplot(data=reproduction, aes(x=factor(Last_AI))) +
