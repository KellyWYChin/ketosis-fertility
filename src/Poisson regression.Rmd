...
fit7.nb3 <- glmmTMB(NumAI ~ AvgKeto20_100 + factor(ad_Lactation) + CalvingSeason + I(PeakDFC/7) + PeakMY + (1|FarmNo), data = Three, family = poisson(link = "log"))
...
######################################
##  fit8.poisson is the best model  ##
######################################
res.fit8.poisson <- simulateResiduals(fit8.poisson)
plot(res.fit8.poisson)
