...
```{r}
ketosis <- Three %>%
  select(AvgKeto20_100, KetoDur20, nHighKeto20, MaxKeto20, MaxKetoDIM20, MaxKetoDIM60)
...
reproduction.ketosis <- Three %>%
  select(DaysToFirstHeat, DaysToFirstIns, NumAI, AvgKeto20_100, MaxKetoDIM60, KetoDur20)
